...
import { faLinkedinIn, faFacebookF, faGithub, faTwitter, faQuora, faMediumM} from '@fortawesome/free-brands-svg-icons';
import { TimelineMax, Power2 } from "gsap/TweenMax";

export default class Contact extends React.Component {
    componentDidMount(){
        var timeline = new TimelineMax();
        timeline.staggerFrom('.personal-statement , .Address, .linkedin', 2, {
            opacity: 0,
            y: -60,
            ease: Power2.easeOut
        }, 0.2)
        timeline.staggerFrom('.github', 0.5, {
            opacity: 0,
            scale: 0.4,
            ease: Power2.ease
        }, 0.2, "-=.6")
        ...
        <div className = "fullscreen" >
                 <section className="location-info">
                     <section className="personal-statement">
                         ...
                         <p>
                            Whether you have questions about projects or are looking to hire me as a software developer for a project/contract. <br /> Or maybe you have suggestions on improvements to this site, or needed clarification on something; 
